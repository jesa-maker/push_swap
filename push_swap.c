...
/*   Updated: 2026/07/22 11:58:51 by jesau            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	push_swap(t_info *info)
{
	...
	if (info->simple)
		...
		medium_algo(info);
	else if (info->complex)
		complex_algo(info);
	else if (info->adaptive)
		algo_decision(info, disorder);
	else
		algo_decision(info, disorder);
	return (0);
}

void	algo_decision(t_info *info, float disorder)
{
	if (disorder < 0.2)
		simple_algo(info);
